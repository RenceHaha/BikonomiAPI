...
function getDailyEarnings($date, $account_id) {
    ...
    $query = "SELECT p.payment_id, p.amount_paid, p.date, p.rent_id, b.bike_id, b.bike_name, bt.bike_type_name, b.image_path, rt.rate_per_minute, r.start_time, r.end_time
              FROM payment_tbl p 
